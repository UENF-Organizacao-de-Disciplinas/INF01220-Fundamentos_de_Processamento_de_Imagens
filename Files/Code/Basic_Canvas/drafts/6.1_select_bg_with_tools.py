...
from tkinter import Tk, ttk, Label, StringVar, Frame
...
def place_elements():
    """ Placing elements """
    f_tools.grid(row=0, column=0, sticky='W')
    select_image.grid(row=0, column=0, sticky='N')
    select_gray.grid(row=0, column=1, sticky='N')

    f_img.grid(row=1, column=0)
